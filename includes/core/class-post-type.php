...
class Post_Type {
	...
	public function registered_post_type() {
		$labels = [
			...
			'add_new_item'       => __( 'Add New Spin Wheel', 'ultimate-spin-wheel' ),
			'new_item'           => __( 'New Spin Wheel', 'ultimate-spin-wheel' ),
			'edit_item'          => __( 'Edit Spin Wheel', 'ultimate-spin-wheel' ),
			'view_item'          => __( 'View Spin Wheel', 'ultimate-spin-wheel' ),
			'all_items'          => __( 'All Spin Wheels', 'ultimate-spin-wheel' ),
			'search_items'       => __( 'Search Spin Wheels', 'ultimate-spin-wheel' ),
			'parent_item_colon'  => __( 'Parent Spin Wheel:', 'ultimate-spin-wheel' ),
		...
		$string_meta_fields = [
			...
			'uspw_schedule_type',
			'uspw_popup_settings',
			'uspw_display_frequency_type',
			'uspw_hide_on_mobile',
			'uspw_hide_on_desktop',
			'uspw_sticky_reopen_button',
			'uspw_sticky_reopen_icon',
			'uspw_sticky_reopen_position',
			'uspw_limit_spin_per_user',
			'uspw_identity_check_type',
			'uspw_show_email_field',
			'uspw_already_played_message',
			'uspw_send_coupon_on_email',
			'uspw_coupon_sent_message',
			'uspw_enable_confetti',
			'uspw_campaign_settings',
			'uspw_form_settings',
			'uspw_content_settings',
			'uspw_design_settings',
			'uspw_behavior_settings',
		];

		foreach ( $string_meta_fields as $meta_field ) {
			register_post_meta('wowdevs_engage', $meta_field, [
				'show_in_rest' => true,
				'single'       => true,
				'type'         => 'string',
				'default'      => '',
		...
		register_post_meta('wowdevs_engage', 'uspw_coupons', [
		...
		register_post_meta('wowdevs_engage', 'uspw_close_duration_button', [
			'type'         => 'integer',
			'single'       => true,
			'default'      => 6,
			'show_in_rest' => true,
